...
class ple_3_12 (osv.Model):
    _name = "l10n_pe.ple_3_12"
    _inherit = "l10n_pe.ple"

    _columns= {
        'lines_ids': fields.one2many ('l10n_pe.ple_line_3_12', 'ple_3_12_id', 'Lines', readonly=True, states={'draft':[('readonly',False)],}),
    }

    def action_reload (self, cr, uid, ids, context=None):
        assert ids and len(ids)==1
        ple_line_obj = self.pool.get('l10n_pe.ple_line_3_12')
        ...
        move_lines = self.get_move_lines (cr, uid, period_ids, '3_12', ple.company_id.id, context=context)
    ...
    def action_report (self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'report_name': 'l10n_pe.sunat_3_12',
            'datas': {},
        }
    ...
    def get_output_filename (self, cr, uid, ids, context=None):
        return "sunat_3_12.txt"

class ple_line_3_12 (osv.Model):
    _name = 'l10n_pe.ple_line_3_12'
    ...
    _columns = {
        'ple_3_12_id': fields.many2one('l10n_pe.ple_3_12', 'PLE', on_delete='cascade'),
        'state': fields.related ('ple_3_12_id', 'state', string='State', type="char"),
        'company_id': fields.related ('ple_3_12_id', 'company_id', string='Company', type="many2one", relation="res.company"),
...
'9' cuando la operación corresponde a un periodo anterior y SI ha sido anotada en dicho periodo."""),
    ...
    def onchange_partner_id (self, cr, uid, ids, partner_id, period_id, context=None):
        vals = {}
        if partner_id:
            ple_3_12_obj = self.pool.get('l10n_pe.ple_3_12')
            period_obj = self.pool.get('account.period')
            partner_obj = self.pool.get('res.partner')
            
            lines = ple_3_12_obj.get_move_lines(cr, uid,
                                                ple_3_12_obj.get_all_periods_up_to(period_id, context=context),
                                                '3_12',
                                                partner_id=partner_id,
                                                context=context)
...
class ple_configuration (osv.osv):
    ...
    def get_report_type (self, cr, uid, context=None):
        ...
        rep_types.append (('3_12', '3.12 Proveedores'))
