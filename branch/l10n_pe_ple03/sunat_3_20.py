...
class ple_3_20 (osv.Model):
    _name = "l10n_pe.ple_3_20"
    _inherit = "l10n_pe.ple"

    _columns= {
        'lines_ids': fields.one2many ('l10n_pe.ple_line_3_20', 'ple_3_20_id', 'Lines', readonly=True, states={'draft':[('readonly',False)],}),
    }
    ...
    def action_report (self, cr, uid, ids, context=None):
        ...
        return {
            ...
            'report_name': 'l10n_pe.sunat_3_20',
            'datas': {},
        }
    ...
    def get_output_filename (self, cr, uid, ids, context=None):
        return "sunat_3_20.txt"

class ple_line_3_20 (osv.Model):
    _name = 'l10n_pe.ple_line_3_20'
    ...
    _columns = {
        'ple_3_20_id': fields.many2one('l10n_pe.ple_3_20', 'PLE', on_delete='cascade'),
        'state': fields.related ('ple_3_20_id', 'state', string='State', type="char"),
        'company_id': fields.related ('ple_3_20_id', 'company_id', string='Company', type="many2one", relation="res.company"),
...
class ple_configuration (osv.osv):
    ...
    def get_report_type (self, cr, uid, context=None):
        ...
        rep_types.append (('3_20', '3.20 Ganancia y pérdidas por función'))
